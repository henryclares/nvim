local M = {}
local global = require("nvim.core.globals")
----------------------------------------------------------------------------------------------------
-- Styles
----------------------------------------------------------------------------------------------------
M.ui = {
...
local filetypes = global.p_table({
...
function M.ui.decorations.get(opts)
	...
	if (not ft and not bt) or not setting then
		return nil
	end
	return {
...
function M.ui.decorations.set_colorcolumn(bufnr, fn)
	...
	local decor = M.ui.decorations.get({ ft = buf.ft, bt = buf.bt, setting = "colorcolumn" })
...
----------------------------------------------------------------------------------------------------
M.ui.current = { border = M.ui.border.line }
